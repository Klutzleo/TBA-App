...
class UserStats(Base):
    ...
    battles_survived    = Column(Integer, nullable=False, default=0)
    total_callings      = Column(Integer, nullable=False, default=0)
    callings_survived   = Column(Integer, nullable=False, default=0)
    callings_clean      = Column(Integer, nullable=False, default=0)
    callings_scarred    = Column(Integer, nullable=False, default=0)
    callings_died       = Column(Integer, nullable=False, default=0)
    total_battle_scars  = Column(Integer, nullable=False, default=0)
    total_bap_used      = Column(Integer, nullable=False, default=0)
    total_tethers_invoked = Column(Integer, nullable=False, default=0)
    total_boosts_applied= Column(Integer, nullable=False, default=0)
...
class StatCheckRequest(Base):
    ...
    player_roll     = Column(Integer, nullable=True)
    ...
    fail_effect     = Column(JSON, nullable=True)                 # {name, modifier, modifier_type, duration_rounds} applied on a loss
