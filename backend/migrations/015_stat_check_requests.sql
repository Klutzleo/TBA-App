...
CREATE TABLE IF NOT EXISTS stat_check_requests (
    ...
    npc_id           UUID REFERENCES characters(id) ON DELETE SET NULL,
    mode             VARCHAR(10) NOT NULL DEFAULT 'character',
    stat             VARCHAR(2) NOT NULL,
    difficulty_die   VARCHAR(8),
    difficulty_label VARCHAR(50),
    sw_roll          INTEGER NOT NULL DEFAULT 0,
    flavor_text      TEXT,
