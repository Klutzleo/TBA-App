...
# The /attack-by-id and /encounter-1v1-by-id routes (DB-mutating, API-key-only,
# unused by the app) were removed in the 2026-09 security pass. DB-integrated
# combat runs through routes/campaign_websocket.py.
